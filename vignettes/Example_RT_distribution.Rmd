...
```{r RT without flowTraceR, eval=FALSE}
...
```
<img src="figures/EXAMPLE-RT-distribution-pic1.png" width="80%" />

## With flowTraceR

```{r RT with flowTraceR, eval=FALSE}
#Example - DIA-NN output
...
ggplot2::ggplot(diann_traceR, aes(x = RT, color = characteristic)) + 
  ...
  scale_x_continuous(limits = c(0,115))
```
<img src="figures/EXAMPLE-RT-distribution-pic2.png" width="80%" />
...
```{r inter-software common, eval=FALSE}
...
ggplot2::ggplot(RT_common, aes(x = RT, color = Software)) + 
  ...
  scale_x_continuous(limits = c(0,115))
```
<img src="figures/EXAMPLE-RT-distribution-pic3.png" width="80%" />

## Unique entries

```{r inter-software unique, eval=FALSE}
...
ggplot2::ggplot(RT_unique, aes(x = RT, color = Software)) + 
  ...
  scale_x_continuous(limits = c(0,115))
```
<img src="figures/EXAMPLE-RT-distribution-pic4.png" width="80%" />
