...
Since only the modifcations UniMod:35 (Oxidation) and UniMod:4 (Carbamidomethyl) are currently supported, **flowTraceR** provides functions to analyze the conversion and shows how much unknown modifications are present in the dataset with `analyze_unknown_mods()`.  
...
<p>&nbsp;</p>
```{r echo=FALSE}
kableExtra::kable(Difference_proteinGroup[["Spectronaut"]], format = "pipe", caption = "Difference in proteinGroup denotation - string_analysis = FALSE")
```
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
```{r echo=FALSE}
kableExtra::kable(Difference_proteinGroup_reduced[["Spectronaut"]], format = "pipe", caption = "Difference in proteinGroup denotation - string_analysis = TRUE")
```
